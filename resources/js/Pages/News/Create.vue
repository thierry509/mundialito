<template>
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white inline-flex items-center">
            <svg class="w-8 h-8 mr-3 p-1.5 bg-primary/10 text-primary rounded-full" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
        ...
        <form @submit.prevent="submit" class="space-y-8" enctype="multipart/form-data">
            ...
            <div class="rounded-xl shadow-md p-6 border border-gray-100 bg-white">
                ...
                <RichText v-model="news.content" name="content" label="Contenu de l'article"
                    placeholder="Rédigez le contenu de votre article ici..." :error="news.errors.content" required />
            </div>
