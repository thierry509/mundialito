...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="text-center mb-8">
            <div class="text-sm uppercase tracking-wider text-primary font-semibold mb-1">Ligue 1</div>
            <h1 class="text-2xl font-bold mb-1">Real Madrid vs FC Barcelone</h1>
            <div class="text-gray-500 text-sm">Stade Santiago Bernabéu • 15 mai 2023 • 20:45</div>
        </div>

        <!-- Score -->
        <div class="flex items-center justify-center mb-8">
            <div class="text-center px-6">
                <div class="text-xl font-bold">Real Madrid</div>
            </div>
            ...
            <div class="text-center px-6">
                <div class="text-xl font-bold">FC Barcelone</div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-3 gap-4 mb-12">
            <div class="space-y-2">
                <div class="text-sm font-medium text-gray-500 text-center">Buteurs</div>
                <ul class="space-y-1">
                    <li class="text-right pr-4 flex justify-end items-center">
                        <span>Vinícius Jr <span class="text-gray-400 ml-1">12'</span></span>
                    </li>
                    <li class="text-right pr-4 flex justify-end items-center">
                        <span>Benzema <span class="text-gray-400 ml-1">67'</span></span>
                    </li>
                </ul>
            </div>

            <div class="flex justify-center items-start pt-8">
                <i class="fas fa-futbol text-gray-300 text-xl"></i>
            </div>

            <div class="space-y-2">
                <div class="text-sm font-medium text-gray-500 text-center">Buteurs</div>
                <ul class="space-y-1">
                    <li class="text-left pl-4 flex items-center">
                        <span>Lewandowski <span class="text-gray-400 ml-1">45'</span></span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <!-- Timeline -->
        <div class="mb-12">
            <h2 class="text-xl font-bold mb-6 text-center">Chronologie du match</h2>

            <div class="relative timeline-item">
                <!-- Événement gauche -->
                <div class="relative mb-6 w-full flex justify-start">
                    <div class="w-1/2 pr-8">
                        <div class="bg-white p-4 rounded-lg border border-gray-100 shadow-sm">
                            <div class="flex items-center text-sm">
                                <div
                                    class="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-white font-bold mr-3">
                                    45'</div>
                ...
                <!-- Événement droite -->
                <div class="relative mb-6 w-full flex justify-end">
                    <div class="w-1/2 pl-8">
                        <div class="bg-white p-4 rounded-lg border border-gray-100 shadow-sm">
                            <div class="flex items-center text-sm">
                                <div
                                    class="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center font-bold mr-3">
                                    12'</div>
                                <div class="flex items-center">
                                    <svg class="h-5 w-5 text-yellow-500 mr-2" viewBox="0 0 24 24" fill="none"
                        ...
                        <div class="bg-white p-4 rounded-lg border border-gray-100 shadow-sm">
                            <div class="flex items-center text-sm">
                                <div
                                    ...
                                    32'</div>
                                <div class="flex items-center">
                                    <svg class="h-5 w-5 text-yellow-400 mr-2" version="1.1" id="Capa_1"
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        viewBox="0 0 34.598 34.598" xml:space="preserve" fill="#000000">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier">
                                            <g>
        ...
        <!-- Commentaires -->
        <div class="mb-8">
            <h2 class="text-xl font-bold mb-4 text-center">Commentaires</h2>
            <div class="bg-white rounded-xl border border-gray-100 p-6 mb-4 min-h-40">
                <!-- Espace commentaires vide -->
            </div>
            <div class="flex">
                <input type="text" placeholder="Écrire un commentaire..."
                    class="flex-1 border border-gray-200 rounded-l-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                <button class="bg-primary text-white px-6 py-3 rounded-r-xl hover:bg-blue-600 transition-colors">
