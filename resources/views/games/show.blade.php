...
@section('content')
    ...
    <!-- Header -->
    <header class="relative py-15 md:py-23 lg:py-31 pt-20 bg-gradient-to-r from-primary to-accent">
        <div class="container mx-auto px-4 py-8 max-w-7xl">
            <div class="absolute inset-0 bg-[url({{ asset('/images/stadium.jpg') }})] bg-cover bg-center opacity-20"
            ...
            <div class="container mx-auto px-4 relative z-10">
                ...
                <div class="flex items-start justify-between mb-8 text-white">
                    ...
                    <div class="text-center flex justify-center h-full w-1/3">
                        @if ($game->team_a_goals !== null && $game->team_b_goals !== null && $game->status == 'finished')
                        ...
                        @else
                            <div class="text-xl md:text-3xl font-bold">VS</div>
                        @endif
                    </div>
                ...
                @if ($game->status == 'finished')
                    ...
                    @if ($goals->count() > 0)
                        <div class="flex justify-center items-start my-8 text-white">
                            ...
                            <div class="flex justify-center items-start w-fit p-0 m-0">
    ...
    <div class="w-full relative p-0">
        ...
        <div class="mx-auto pt-4 max-w-7xl py-4">
            ...
            @include('comment.index', ['type' => 'game', 'CommentableId' => $game->id])
        </div>
    </div>
@endsection
