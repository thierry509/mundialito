...
@section('content')
<div class="min-h-screen bg-cover bg-center flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" style="background-image: url('https://img.freepik.com/photos-gratuite/concept-faire-du-sport_23-2151937746.jpg')">
    <div class="w-full lg:w-4/6 bg-white p-8 rounded-xl shadow-2xl backdrop-blur-sm">
        ...
        <div class="mt-6 grid grid-cols-2 gap-3">
            <button class="flex items-center w-full justify-center bg-white border border-gray-300 rounded-lg px-4 py-2 text-sm font-medium text-gray-800 hover:bg-gray-100">
